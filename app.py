...
class calculator:
    ...
    # Both Thumb and Index Fingers Up in Drawing Mode
        ...
        # Only draw if previous points are valid
    ...
    # Reset points if no valid drawing mode
        else:
            self.p1, self.p2 = 0, 0
    ...
    # Ensure imgCanvas is defined and accessible
        ...
        genai.configure(api_key="AIzaSyBVpbXIHP57tozX9ZPSyKQiqYnscAQ_CVU" )
